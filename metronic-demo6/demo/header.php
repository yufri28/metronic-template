<?php
    $koneksi = mysqli_connect("localhost","root","","navbar_dinamis");
    // Check connection
    if (mysqli_connect_errno()){
        echo "Koneksi database gagal : " . mysqli_connect_error();
    }
    $parentMenu = mysqli_query($koneksi,"SELECT * FROM parent_menu");
?>
                ...
                <div class="hover-scroll-overlay-y my-2 my-lg-5 pe-lg-n1" id="kt_aside_menu_wrapper"
                    ...
                    <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold"
                        ...
                        <div class="menu-item py-2">
                            <a class="menu-link actives menu-center" href="<?=$parent['link_parent'];?>"
                        ...
                        <?php else:?>
                        <?php $sub_menu = mysqli_query($koneksi,"SELECT * FROM sub_menu WHERE parent_id='".$parent['id_menu']."'"); ?>
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-2">
                            ...
                            <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-item">
                                        <!-- (4) Link sub menu -->
                                        <a class="menu-link" href="<?=$sub['link_menu'];?>">
                        ...
                        <?php endforeach;?>
                        <div class="menu-item py-2">
                            <a class="menu-link actives menu-center" href="#" data-bs-trigger="hover"
                                data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-icon me-0">
                                    <i class="bi bi-gear fs-2"></i>
                                </span>
                                <span class="menu-title text-center">Management Menu</span>
                            </a>
                        </div>
                    </div>
                    <!--end::Menu-->
