            ...
            <div class="col-xxl-4">
                ...
                <div class="card card-xxl-stretch">
                    ...
                    <div class="card-body d-flex flex-column">
                        <!--begin::Chart-->
                        <div class="mixed-widget-5-chart card-rounded-top" data-kt-chart-color="warning"
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_614852366e481" data-allow-clear="true">
                                                <option></option>
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-0">
                    ...
                    <div class="card-body d-flex flex-column pb-10 pb-lg-15">
                        <div class="flex-grow-1">
                            ...
                            <!--end::Info-->
                            <!--begin::Link-->
                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-4">PitStop - Multiple Email
                                Generator</a>
                            <!--end::Link-->
                            <!--begin::Desc-->
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-0">
                    ...
                    <div class="card-body d-flex flex-column pb-10 pb-lg-15">
                        <div class="flex-grow-1">
                            ...
                            <!--end::Info-->
                            <!--begin::Link-->
                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-4">KT.com - High Quality
                                Templates</a>
                            <!--end::Link-->
                            <!--begin::Desc-->
